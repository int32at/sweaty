...
/**
 * Author: karl roberts Date: 2-Mar-2005 Time: 15:34:26
 *
 * Thanks to Tom Daley who posted the Base 64encode algorithm at
 * http://www.javaworld.com/javaworld/javatips/jw-javatip36-p2.html allowing me
 * to create the decoding
 *
 * the Base64 encoding can be represented by <img
 * src="http://www.javaworld.com/javaworld/javatips/images/Base64Encoding.gif"/>
 * 
 * @author jkyr
 *
 */
public class Base64 {
	...
	public static String decode(byte[] encoded, String encoding)
			throws UnsupportedEncodingException {
		if (encoded == null) {
